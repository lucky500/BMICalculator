                ...
                <div className="container">
                  <div className={"col-md-12 primary"}>
                    <ul className='nav navbar-nav'>
                        ...
                        <li className={"applications " + this.getActiveClass() } onClick={()=> this.toggleCategories('applications')} data-toggle="tab" data-target=".tab-applications" name="applications"><Link to="/applications"><span>Applications</span></Link></li>
